        ...
        <div class="row justify-content-center" v-show="$gate.isAdmin()">          
          <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form @submit.prevent="updateStructure" @keydown="form.onKeydown($event)">
                        ...
                        <fieldset class="col-md-3">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <textarea rows="3" v-model="form.str_notes" name="str_notes" class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('str_notes') }"></textarea>
...
export default {
    ...
    methods: {
         getStructure(){
            axios.get('api/structures/show/'+this.str_id)
            .then(({data})=>(       
                this.form.fill(data)
            ));           
        },
        updateStructure(){
            this.form.put('api/structures/edit/'+this.str_id).then(()=>{
                    Toast.fire({
                    type: 'success',
                ...
                Toast.fire({
                type: 'warning',
                title: 'Structure failed to update.'
            })
            })

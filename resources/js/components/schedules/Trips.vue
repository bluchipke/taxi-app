                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">                             
                            ...
                            <div class="col-md-2" v-show="$gate.isDriver()">
                                <router-link :to="'/driver/start/trip'" class="btn btn-xs btn-flat btn-primary btn-block" >START TRIP</router-link>
                            </div>
                            <div class="col-md-2">
                        ...
                        <table class="table table-striped table-fixed">
                            ...
                            <tbody>
                                <tr v-for="d in trips.data" :key="d.trip_id">
                                    ...
                                    <td v-show="d.completed == 1 && $gate.isDriver()"><a href="#" @click.prevent="showTrip(d.trip_id)"><i class="fa fa-folder fa-2x" title="COMPLETED"></i></a> </td>
                                </tr>                                
                            </tbody>
                        </table>
                    </div>
...
export default {
    ...
    methods: {
        ...
        getTrips(){
            axios.get('api/schedules/'+this.schedule_id).then(({ data})=>(this.trips = data));
        },
        searchV(){

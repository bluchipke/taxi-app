                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-2 mt-2" style="padding-left: 8px !important;">                               
                            <button :disabled="form.busy" type="submit" class="btn btn-sm btn-block btn-flat btn-success"><i class="fa fa-check"></i> UPDATE</button>
                        </div>
                         <div class="col-md-2 mt-2">                               
                            <button :disabled="form.busy" @click.prevent="deleteClient" class="btn btn-sm btn-block btn-flat btn-danger"> <i class="fa fa-trash"></i> DELETE</button>
                        </div>
                    </div>
                    </form>
                </div>
...
export default {   
    ...
    methods: {
        ...
        updateClient(){
            this.form.put('api/organizations/'+this.client_id).then(()=>{
                Toast.fire({
                    type: 'success',
            ...
            .catch(()=>{
                Toast.fire({
                    type: 'error',
                    title: 'Client update failed. Please try again later.'
                })
            });
        },
        ...
        deleteClient(){
            swal.fire({
                ...
                //send delete request to the server;                
                    if (result.value) {
                        this.form.delete('api/organizations/'+this.client_id).then(()=>{
                            swal.fire('Deleted!',

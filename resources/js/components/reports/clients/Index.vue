...
export default {
    ...
    methods: {
        ...
        generateReport(){
            ...
            this.$Progress.start();            
                window.open('../reports/clients/'+this.id+'/fm/'+this.form.date1+'/tn/'+this.form.date2,'popUpWindow','height='+screen.height+',width='+screen.width+',left=100,top=100,resizable=no,scrollbars=yes,toolbar=no,menubar=no,location=no,directories=no, status=yes');            
